...
名前候補と命名画面だけを変更する見た目・操作補助MODです。所持品、能力値、収穫、戦闘、時間経過、動物の性能は変更しません。

## 変更すること

- 新しく名前を付ける動物のランダム候補を日本語名へ置き換えます。
- 設定したカテゴリと独自候補を抽選対象にします。
- 動物図鑑から本編の新規命名画面を開けるようにします。

## 変更しないこと

- すでに付いている動物名、動物の種類・性別・能力・販売価格。
